          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text("${routes.length} Routes Found", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return Card(
                    ...
                    shape: isSelected
                        ? RoundedRectangleBorder(side: const BorderSide(color: Colors.teal, width: 2), borderRadius: BorderRadius.circular(10))
                        : null,
                    child: ExpansionTile(
                      leading: Icon(
                      ...
                      title: Text(
                        ...
                        style: TextStyle(fontWeight: FontWeight.bold, color: isRecommended ? Colors.teal : Colors.black),
                      ),
                      ...
                      children: [
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (ctx, j) {
                              ...
                              return ListTile(
                                ...
                                title: Text(step.instruction, style: const TextStyle(fontSize: 13)),
                                subtitle: stepIssues.isNotEmpty
                                    ? Text("⚠ ${stepIssues.join(', ')}", style: const TextStyle(color: Colors.red, fontSize: 11))
                                    : null,
                              );
                            },
                          ),
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(backgroundColor: Colors.teal, minimumSize: const Size(double.infinity, 40)),
                            child: const Text("START THIS ROUTE", style: TextStyle(color: Colors.white)),
                          ),
                        )
                      ],
                    ),
